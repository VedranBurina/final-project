// Selektiraj gumb za filtriranje bilješki koje su izvršene
const FILTER_COMPLETED_BTN = document.getElementById("filter-completion1-btn");

// Dodaj slušač događaja na klik gumba za filtriranje
FILTER_COMPLETED_BTN.addEventListener("click", () => {
    // Izvrši HTTP zahtjev za dohvat filtriranih bilješki koje su izvršene
    fetch("../src/filter notes/filter_completion1.php")
